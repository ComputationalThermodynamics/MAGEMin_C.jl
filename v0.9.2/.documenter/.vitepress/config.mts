...
const baseTemp = {
  base: '/MAGEMin_C.jl/v0.9/',// TODO: replace this in makedocs!
}
...
{ text: 'Bulk-rock input file', link: '/MAGEMinApp/bulk_rock' },
{ text: 'Phase diagrams tutorials', link: '/MAGEMinApp/PD_tutorials' },
{ text: 'P-T-X paths tutorials', link: '/MAGEMinApp/PTX_tutorials' },
{ text: 'Isentropic paths tutorials', link: '/MAGEMinApp/isoS_tutorials' },
...
{ text: 'Tutorials', link: '/MAGEMin_C/tutorials' },
{ text: 'API', link: '/api' }]
 },
