...
This tutorial demonstrates how to perform multi-threaded fractional crystallization calculations using MAGEMin_C.jl, enabling parallel computation of multiple liquid lines of descent across different starting pressures.

::: tip Info
- [Threaded fractional crystallization](/MAGEMin_C/threaded_fractional_crystallization#Threaded-fractional-crystallization)
...
- Some basic background in `Julia` programming, in particular multi-threading, is recommended.
  

:::

## Threaded fractional crystallization {#Threaded-fractional-crystallization}
