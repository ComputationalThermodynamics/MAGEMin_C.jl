...
# MAGEMin_C.jl: Isentropic path calculation {#MAGEMin_C.jl:-Isentropic-path-calculation}
...
::: tip Info
- [Isentropic path calculation](/MAGEMin_C/isentropic_path#Isentropic-path-calculation)
