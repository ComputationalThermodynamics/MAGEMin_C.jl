...
::: tip Info
- [Single point trace element partitioning](/MAGEMin_C/trace_elements#Single-point-trace-element-partitioning)
  
- [Trace element partitioning](/MAGEMin_C/trace_elements#Trace-element-partitioning)
...
#### Plot Li mass fraction {#Plot-Li-mass-fraction-2}
...
#### Plot Zr saturation and Zr mass fraction in melt {#Plot-Zr-saturation-and-Zr-mass-fraction-in-melt}
