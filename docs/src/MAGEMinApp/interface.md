...
Available thermodynamic databases are presented [here](@ref thermodynamic_database). All other options and parameters are detailed below.
...
!!! note
    Trace-element partitioning model descriptions and Kd tables are documented in the [Thermodynamic Databases](@ref thermodynamic_database) page.
