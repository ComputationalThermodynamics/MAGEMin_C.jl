...
### 2. Load MAGEMin_C and Plots packages
...
### 5. Call single point minimization routine
...
### 6. Perform the stable phase equilibrium calculation
...
### 8. Retrieve garnet composition in wt
...
!!! warning
    The ordering of the output oxides may differ from the input ones. This is because MAGEMin internally reorganizes them.
    To check the ordering of the oxides in the out structure simply type:
...
### 10. Plot melt and solid bulk composition
...
### E.1. Calculate residual composition
