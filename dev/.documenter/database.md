...
::: tip Info
- [Quick Reference Table](/database#Quick-Reference-Table)
  
- [Detailed Database Descriptions](/database#Detailed-Database-Descriptions)
  
- [Important Notes](/database#Important-Notes)
  
- [Reference Citations](/database#Reference-Citations)
  
- [Phase and End-member Listing](/database#Phase-and-End-member-Listing)
  
- [Trace-element partitioning models](/database#Trace-element-partitioning-models)
  - [OL fixed Kd database](/database#OL-fixed-Kd-database)
    
  - [CO lattice strain model](/database#CO-lattice-strain-model)
...
#### Mafic compositions {#Mafic-compositions}
...
#### Intermediate compositions {#Intermediate-compositions}
...
#### Felsic compositions {#Felsic-compositions}
...
#### Elements and output order {#Elements-and-output-order}
...
#### Brice lattice strain equation {#Brice-lattice-strain-equation}

The partition coefficient of an element _i_ entering a crystallographic site of optimal-fit radius _r₀_ is:
...
- 
  $$D_0$$
  — peak partition coefficient at the optimal ionic radius $r_0$
...
- 
  $$r_i$$
  — ionic radius of element _i_ in the relevant coordination (Shannon, 1976)
...
#### Mineral-specific models {#Mineral-specific-models}
