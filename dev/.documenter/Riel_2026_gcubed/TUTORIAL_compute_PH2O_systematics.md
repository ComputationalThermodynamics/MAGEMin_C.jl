...
> 
> _For a metapelite rock at a given pressure and water content, how much does Lithium (Li) get concentrated in the melt when partial melting occurs?_
> 
...
## Step 1 — Entry Point and Parameter Setup {#Step-1-—-Entry-Point-and-Parameter-Setup}
...
### Stage A: Bulk Rock Setup {#Stage-A:-Bulk-Rock-Setup}
...
`norm2one()` normalizes the oxide vector to sum to 1.0. The oxides are: `[SiO₂, Al₂O₃, CaO, MgO, FeO, K₂O, Na₂O, TiO₂, O, MnO, H₂O]`

H₂O is initially set to 0 — it will be varied across the H axis of the grid.

### Stage B: Water Saturation Curve {#Stage-B:-Water-Saturation-Curve}
...
### Stage C: KD Database {#Stage-C:-KD-Database}
...
### Stage E: Threaded Calculation {#Stage-E:-Threaded-Calculation}
...
### Stage F: Post-processing and Plotting {#Stage-F:-Post-processing-and-Plotting}
...
## Step 3 — The Water Saturation Curve {#Step-3-—-The-Water-Saturation-Curve}
...
## Step 4 — Partition Coefficient Models {#Step-4-—-Partition-Coefficient-Models}
...
## Step 5 — Threading Architecture {#Step-5-—-Threading-Architecture}
...
### The Solution: Static Thread Scheduling {#The-Solution:-Static-Thread-Scheduling}
...
### The Grid Index Mapping {#The-Grid-Index-Mapping}
...
### The Saturation Filter {#The-Saturation-Filter}
...
### Thread Safety of Writes {#Thread-Safety-of-Writes}
...
### Visualizing the Threading {#Visualizing-the-Threading}
...
## Step 6 — The Fractional Melting Engine {#Step-6-—-The-Fractional-Melting-Engine}
...
#### 6.1 — Set Bulk Composition {#6.1-—-Set-Bulk-Composition}
...
#### 6.2 — Set Initial Trace Element {#6.2-—-Set-Initial-Trace-Element}
...
#### 6.3 — Find the Solidus {#6.3-—-Find-the-Solidus}
...
#### 6.4 — Extraction Event Loop {#6.4-—-Extraction-Event-Loop}
...
#### 6.5 — Early Exit Conditions {#6.5-—-Early-Exit-Conditions}
...
## Step 7 — Post-Processing: `retrieve_outputs()` {#Step-7-—-Post-Processing:-retrieve_outputs}
...
## Step 8 — Plotting: `plot_output()` {#Step-8-—-Plotting:-plot_output}
...
## Step 9 — Custom Biotite Margules Parameters {#Step-9-—-Custom-Biotite-Margules-Parameters}
