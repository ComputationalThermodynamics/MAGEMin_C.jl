...
> 
> _At what temperatures do successive melt extraction events occur, and how does that change with pressure along a water-saturated pelite solidus?_
> 
...
### One Dimension: Pressure {#One-Dimension:-Pressure}
...
## Step 1 — Setup and Parameters {#Step-1-—-Setup-and-Parameters}
...
## Step 2 — Threaded Calculation via `perform_threaded_calc_EE()` {#Step-2-—-Threaded-Calculation-via-perform_threaded_calc_EE}
...
### What `perform_threaded_calc_EE()` Returns vs. `perform_threaded_calc()` {#What-perform_threaded_calc_EE-Returns-vs.-perform_threaded_calc}
...
## Step 3 — Extracting Extraction Temperatures {#Step-3-—-Extracting-Extraction-Temperatures}
...
## Step 4 — Assembling the `T_curves` Matrix {#Step-4-—-Assembling-the-T_curves-Matrix}
...
## Step 5 — Plotting {#Step-5-—-Plotting}
