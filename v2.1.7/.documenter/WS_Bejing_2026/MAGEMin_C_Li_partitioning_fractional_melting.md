...
### 4. Non-linear partition coefficient model {#4.-Non-linear-partition-coefficient-model}
...
### E.1. Non-linear biotite partition coefficient model {#E.1.-Non-linear-biotite-partition-coefficient-model}
